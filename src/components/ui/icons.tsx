...
export const MicLargeIcon = ({ className = "w-7 h-7 shrink-0" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const StopLargeIcon = ({ className = "w-7 h-7 shrink-0" }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const AppleIcon = ({ className = "w-4 h-4 shrink-0" }: { className?: string }) => (
